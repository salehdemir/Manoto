...
import com.example.bukhara.databinding.FragmentSearchBinding
...
class SearchFragment : Fragment() {
    ...
    private val menuItems = mutableListOf<MenuItemsModel>()
...
//        reference to the menu node
    ...
    private fun setAdapter(filteredMenuItem: List<MenuItemsModel>) {
